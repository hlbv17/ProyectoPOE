...
namespace Visual {
    public partial class Frm_AtencionMedica_Eliminar : Form {
        ...
        public Frm_AtencionMedica_Eliminar (DateTime fecha, string hora, string paciente, Frm_AtencionMedica_Busca frmB) {
            InitializeComponent ();
