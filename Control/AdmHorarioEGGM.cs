...
namespace Control
{
    public class AdmHorarioEGGM
    {
        private static AdmHorarioEGGM adm = null;
        ...
        public static AdmHorarioEGGM GetAdm()
        {
            if (adm == null)
            {
                adm = new AdmHorarioEGGM();
            }
            return adm;
        }
        private AdmHorarioEGGM()
        {
        ...
        public void llenarGridOdo(DataGridView dgvHorarioOdontologo, DataGridView dgvHorario)
        {
            ...
            int o = dgvHorarioOdontologo.Rows.Count; int i = 1;
            if (o == 0)
            {
                horarioOdont.Clear();
